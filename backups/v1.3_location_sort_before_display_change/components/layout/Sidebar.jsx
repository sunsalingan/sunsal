...
const Sidebar = ({ isOpen, onClose, user, handleLogout, onSearch, onChangeViewMode, currentViewMode, onOpenUserSearch }) => {
    return (
        <>
            {/* Backdrop */}
            <div
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto py-4">
                    ...
                    <div className="space-y-1 px-3">
                        ...
                        />
                        <SidebarItem
                            icon={<Users size={18} className={currentViewMode === "FRIENDS" ? "text-indigo-600" : ""} />}
                            label="👥 지인 랭킹 (Friends)"
                            onClick={() => onChangeViewMode && onChangeViewMode("FRIENDS")}
                        ...
                        <div className="px-3 mb-2">
                            <button
                                ...
                                className="w-full py-2 bg-indigo-600 text-white rounded-lg text-sm font-bold flex items-center justify-center gap-2 hover:bg-indigo-700 shadow-md shadow-indigo-100 transition-colors"
                            >
                                <Users size={16} /> + 친구 찾기
                            </button>
                        </div>
